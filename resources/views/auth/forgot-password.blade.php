...
<head>
    ...
    <title>Forgot Password - HAU QA Portal</title>
    <!-- Google Fonts -->
...
<body class="h-full font-sans antialiased text-gray-900 flex items-center justify-center p-4 bg-gradient-to-br from-hau-maroon via-hau-maroon-dark to-gray-900">
    <div class="w-full max-w-md bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-8 space-y-6">
        ...
        <div class="text-center space-y-2">
            ...
            <h2 class="text-2xl font-black text-gray-900 tracking-tight">Forgot Password?</h2>
        ...
        <form action="{{ route('password.email') }}" method="POST" class="space-y-4">
            ...
            <button type="submit" 
                class="w-full py-3 px-4 bg-hau-maroon hover:bg-hau-maroon-dark text-white font-bold text-sm rounded-xl transition duration-150 shadow-md hover:shadow-lg focus:outline-none">
